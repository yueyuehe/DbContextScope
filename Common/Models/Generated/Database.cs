...
//     Connection String:      `Data Source=.;Initial Catalog=HWAdmin;User ID=sa;Password=sa123456`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace HWAdmin
{
    ...
    public partial class Account : HWAdminDB.Record<Account>  
    {
		...
		[Column] public string CreateUser_Id { get; set; }





		[Column] public string UpdateUser_Id { get; set; }
    ...
    public partial class Action : HWAdminDB.Record<Action>  
    {
    ...
    public partial class Authority : HWAdminDB.Record<Authority>  
    {
		...
		[Column] public string AuthorityType { get; set; }
    ...
    public partial class AuthorityAccount : HWAdminDB.Record<AuthorityAccount>  
    {
		...
		[Column] public string Authority_Id { get; set; }
    ...
    public partial class FileInfo : HWAdminDB.Record<FileInfo>  
    {
		...
		[Column] public string FileSaveName { get; set; }
    ...
    public partial class T_SYS_ErrorLog : HWAdminDB.Record<T_SYS_ErrorLog>  
    {
		...
		[Column] public string FormParams { get; set; }
		...
		[Column] public string Cookie { get; set; }
