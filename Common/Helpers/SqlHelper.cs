...
namespace Common.Helpers
{
    ...
    public class SqlHelper
    {
        ...
        /// </summary>   
        /// <returns></returns>   
        public static string GetConnSting(ConnectionString conStr)
        {
            string connectionStr = "";
            switch (conStr)
            {
                ///systemCon
                case ConnectionString.TBMS:
                    connectionStr = ConfigurationManager.ConnectionStrings["FTCE_TBMS_SystemCon"].ConnectionString;
                    break;
                case ConnectionString.ACCS:
                    connectionStr = ConfigurationManager.ConnectionStrings["FTCE_ACCS_SystemCon"].ConnectionString;
                    break;
                default:
                    break;
            }
        ...
        /// </summary>   
        /// <returns></returns>   
        public static SqlConnection GetConnection(ConnectionString conStr)
        {
            SqlConnection Connection = new SqlConnection(SqlHelper.GetConnSting(conStr));
            return Connection;
        }
        #endregion
