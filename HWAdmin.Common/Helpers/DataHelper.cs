...
namespace HWAdmin.Common.Helpers
{
    ...
    public class DataHelper
    {
        ...
        /*
        public TModel BindData<TModel>() where TModel : new()
        {
            //var Request = System.Web.HttpContext;
            ...
            props.ToList().ForEach(
                    pi =>
                    {
                        if (!pi.PropertyType.IsGenericType)
                        {
                            ...
                            {
                                pi.SetValue(model, Convert.ChangeType(Request[pi.Name], pi.PropertyType), null);
                            }
                        }
                        else
                        {
                            ...
                            if (genericTypeDefinition == typeof(Nullable<>))
                            {
                                ...
                                {
                                    pi.SetValue(model, Convert.ChangeType(Request[pi.Name], Nullable.GetUnderlyingType(pi.PropertyType)), null);
                                }
                            }
                        }
                    });
        ...
        */
        ...
        /// 获取可空属性的基础类型
        /// </summary>
        public object GetNullType(PropertyInfo p)
        {
